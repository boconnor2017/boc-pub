<#  
    The following script can be used to install the management agent on a vRealize Automation IaaS
    Windows machine. Run this script prior to start of the vRealize Automation 7.x installation wizard
    on each of the Windows machines. This script can be downloaded at https://vra_fqdn:5480/i by clicking
    "PowerShell script". 
#>

Param (
    [string]$vaAddress = "https://vra_fqdn:5480",
    [string]$ServiceUserName = "domain\username",
    [string]$ServiceUserPassword = "password",
    [string]$vaRootUserPassword = "password",
...
function InstallMA()
{
    ...
    $exitCode = (Start-Process -FilePath $Env:SystemRoot\system32\msiexec.exe -ArgumentList $CommandParams -Wait -Passthru).ExitCode
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUglNGA/6S+r1wVHa8E1+LuBQl
# 4yWgghlLMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# IwYJKoZIhvcNAQkEMRYEFHeJ84cmme3NB6E8sM+bwAZRAsciMCoGCisGAQQBgjcC
# AQwxHDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wDQYJKoZIhvcNAQEBBQAE
# ggEAxHYmCnfOd5Zu1sgfvsYjine/weeL/OOjovbnJvqhTyYq5aqCSYRV9B9vbmHP
# etLivUD52EpXjwVCMh8A5UVH8lFLaA1FqL4VLI95B7BOJsr520hK7+Pv08WkKvDU
# OFzGWQ3QZuX94XK/JClJoo5c2Y+VVR3S2q1WQ22dMd6WGAn0OC91bjtrvTwiTVlw
# km0oFIGyePnqLBlItuKAogKWLW4ugKx0tL32PxkBLBEhhdcc8UeeRMJkxS+FdIJo
# 7CzK3INGNtVcpwt32cPKG7wQ1YNla4C7x6OMbBTVdKpcUIXo3DlttvzV8mhD4gF3
# hIz69ehN4X/yWNPb7G2wFu3J9aGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIB
...
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNzA1MDYxNTE5MjhaMCMGCSqG
# SIb3DQEJBDEWBBRobmtZhnaUFBhBc571he/AmEydgjANBgkqhkiG9w0BAQEFAASC
# AQAHiS4U+QWjAWtVkiFTHc7ChpaQDIiytFlTeDIBCtJZW8lJPKah/8G5zcyx/AMQ
# FfPiEeOccCQr4x5CAvpXSn8HIogWQopcPg2uUy4KPJqL2MlPhVeiWroIU2wnRz/m
# Jwe5WLZS1/Eq5aA3cSyzBAaSrcr5wyqYGrZ0xqDYC1xcPIzNnmvNE8H3yKAMasCc
# 1bnzHyVXaQr94hYmsGQbQbv73JbtJAzhU2h3o1zqmMaj1icg8kYz3Xxlh5sjr1EV
# VmCRvIFmQDfYHMtGfYU0gcKQnafoXZwKvzMwpR5WEqOWUgFZFCSJVc3zevyDPrR2
# zVfe28KNSaClLWohuInHDL5A
