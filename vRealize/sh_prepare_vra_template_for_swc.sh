...
InstallSoftwareAgent()
{
	...
	if [[ $use_rpm = "true" ]]; then
		package_file_name="vmware-vra-software-agent-service_7.3.0.0-0_$archSoftwareAgentRPM.rpm"
	else
		package_file_name="vmware-vra-software-agent-service_7.3.0.0-0_$archSoftwareAgentDEB.deb"
	fi
